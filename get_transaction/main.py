...
def get_transaction():
    if request.headers['X-Forwarded-Host'] == 'api.worbli.eostribe.io':
        ELASTIC_INDEX = "worbli_transaction_traces*"
    elif request.headers['X-Forwarded-Host'] == 'api.bos.eostribe.io':
        ELASTIC_INDEX = "bos_transaction_traces*"
    elif request.headers['X-Forwarded-Host'] == 'api.telos.eostribe.io':
        ELASTIC_INDEX = "telos_transaction_traces*"
    else:
        ELASTIC_INDEX = "transaction_traces*"
    ...
    seeking_result = seeking_transaction(transaction_id, ELASTIC_INDEX)
